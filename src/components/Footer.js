        ...
        <Row className="g-3">
          <Col md={6}>
            <ListGroup>
              ...
              <ListGroup.Item><a href="https://instagram.com">Instagram</a>, <a href="https://facebook.com">Facebook</a>, <a href="https://mermisi.edu.ge">School website</a>, <a href="https://github.com/Mermisi-Self-Gov">GitHub</a> </ListGroup.Item>
            </ListGroup>
          </Col>
          <Col md={6}>
            <ListGroup>
